...
\begin{component}{Academic Papers}
	\begin{itemize}
		...
		\item[] ``The Worst Video You Have Ever Seen: Exacerbating the Computation Time of Systems,'' Eric Kim, Jonathan Kotker, Sunil Pedapudi, Sanjit Seshia, and David Wagner. December 2011.
	\end{itemize}
\end{component}
