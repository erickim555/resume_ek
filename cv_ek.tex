...
recognition, image understanding, and 3D reconstruction.
\end{component}

\vspace{0.5em}

\begin{component}{Education}
    \school{University of California, Los Angeles}{Computer Science}{M.S.}{09/2013 -- 06/2015}
...
\begin{component}{Research Experience}
    \begin{position}{Research Assistant}{September 2014 -- Present}
        {University of California, Los Angeles}{Department of Computer Science}
    {Worked on extending the ``TensorFaces'' face recognition approach to perform identity, gender, and ethnicity recognition.}
    \end{position}
