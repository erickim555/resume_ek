...
Computer Vision, Machine Learning, and Electronic Voting.
In particular, I am interested in bridging the ``semantic gap'' via the
design of general vision algorithms that can reason about image or video streams at
a high-level. Specific applications include human action recognition, scene categorization,
and video analysis.
\end{component}
